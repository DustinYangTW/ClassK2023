...
namespace MyModel_CodeFirst.Controllers
{
    public class BooksController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("GId,Title,Description,Photo,ImageType,Author,TimeStamp")] Book book)
        {
            if (id != book.GId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'GuestBookContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
